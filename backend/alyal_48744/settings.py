"""
Django settings for alyal_48744 project.
...
WSGI_APPLICATION = 'alyal_48744.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "ALYAL Support <support@alyal-48744.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alyal_48744 API",
    "DESCRIPTION": "API documentation for alyal_48744 App",
    "VERSION": "v1",
}
